...
<html lang="en">
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Data Masukkan</li>
						</ul><!-- /.breadcrumb -->
					</div>
								...
								<div class="row">
									...
									<div class="col-sm-4 form-group">
										<span class="input-icon input-icon-right" style="width: 100%">
											<input type="text" id="cari" style="width: 100%" placeholder="Cari Nama / Masukkan">
		...
		<script src="<?php echo base_url(); ?>js/masukkan/data_masukkan.js?v=1.0.1" type="text/javascript"></script>
