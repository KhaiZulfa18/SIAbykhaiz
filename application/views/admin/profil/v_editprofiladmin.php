...
<html lang="en">
	...
	<body class="no-skin">
							...
							<div class="col-xs-11">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="nama" name="nama" placeholder="Nama" class="col-xs-10 col-sm-5" value="<?php echo $nama; ?>"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="username" name="username" placeholder="Username" class="col-xs-10 col-sm-5" value="<?php echo $username; ?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="nip" name="nip" placeholder="NISN" class="col-xs-10 col-sm-5" value="<?php echo $nip; ?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="telepon" name="telepon" placeholder="No. Telepon" class="col-xs-10 col-sm-5" value="<?php echo $telepon; ?>"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group col-xs-10 col-sm-5">
												<input class="form-control date-picker" id="tgl_lahir" type="text" data-date-format="dd-mm-yyyy" readonly="" style="background: #fff!important;" value="<?php echo $tgl_lahir; ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea type="text" id="alamat" name="alamat" placeholder="" class="col-xs-10 col-sm-5"><?php echo $alamat; ?></textarea>										
										</div>
									</div>
		...
		<script src="<?php echo base_url(); ?>js/profil/edit_admin.js?v=1.0.3" type="text/javascript"></script>
