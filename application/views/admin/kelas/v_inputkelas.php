...
<html lang="en">
	...
	<body class="no-skin">
							...
							<div class="col-xs-11">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="nama" name="nama" placeholder="Nama Kelas" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kelas </label>
											...
											<select id="kelas" name="kelas" class="col-xs-10 col-sm-5" >
												<option class="">--------------- Pilih Kelas --------------</option>
		...
		<script src="<?php echo base_url(); ?>js/kelas/input_kelas.js?v=1.0.1" type="text/javascript"></script>
