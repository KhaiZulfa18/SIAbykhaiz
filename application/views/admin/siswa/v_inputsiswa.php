...
<html lang="en">
	...
	<body class="no-skin">
							...
							<div class="col-xs-11">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="nisn" name="nisn" placeholder="NISN" class="col-xs-10 col-sm-5" />
										</div>
									</div>
		...
		<script src="<?php echo base_url(); ?>js/siswa/input_siswa.js?v=1.0.1" type="text/javascript"></script>
