...
<html lang="en">
	...
	<body class="no-skin">
								...
								<div class="row">
									<form class="form-horizontal" role="form" >
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="penerima" class="col-xs-10 col-sm-5">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="subject" id="subject" placeholder="Subject" class="col-xs-10 col-sm-5">
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pesan </label>
										...
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="button" id="btnsent">
		...
		<script src="<?php echo base_url(); ?>js/email/sentemail.js?v=1.1.2" type="text/javascript"></script>
