...
<html lang="en">
	...
	<body class="no-skin">
							...
							<div class="col-xs-11">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<input type="hidden" name="id_guru" id="id_guru" value="<?php echo $idguru; ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="mtk" name="mtk" placeholder="Isi Nilai" class="col-xs-10 col-sm-2" />
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="indo" name="indo" placeholder="Isi Nilai" class="col-xs-10 col-sm-2" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="inggris" name="inggris" placeholder="Isi Nilai" class="col-xs-10 col-sm-2"/>
										</div>
									</div>
		...
		<script src="<?php echo base_url(); ?>js/nilai/input_nilai.js?v=1.0.2" type="text/javascript"></script>
