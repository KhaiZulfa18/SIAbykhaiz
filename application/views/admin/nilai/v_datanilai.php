...
<html lang="en">
	...
	<body class="no-skin">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div class="col-sm-3 form-group">
										<select id="orderby" class="form-control" style="width: 100%">
											<option value="">- Mata Pelajaran -</option>
											<option value="mtk">Matematika</option>
											<option value="indo">Bahasa Indonesia</option>
											<option value="inggris">Bahasa Inggris</option>
											<option value="rerata">Rata-rata</option>
										</select>
									</div>
									<div class="col-sm-3 form-group">
										<select id="ordertype" class="form-control" style="width: 100%">
		...
		<script src="<?php echo base_url(); ?>js/nilai/data_nilai.js?v=1.1.1" type="text/javascript"></script>
